...
import { useGetOrderDetailsQuery, useDeliverOrderMutation, usePayOrderMutation } from '../slices/orderApiSlice';
...
const OrderScreen = () => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      navigate(`/${orderId}/payment-success`);
      refetch(); // Refetch to update the order status in UI
    } catch (err) {
